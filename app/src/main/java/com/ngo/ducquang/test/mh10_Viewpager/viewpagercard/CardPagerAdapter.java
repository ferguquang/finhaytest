...
public class CardPagerAdapter extends PagerAdapter implements CardAdapter
{
    ...
    {
        TextView titleTextView = (TextView) view.findViewById(R.id.nameAnimal);
        TextView contentTextView = (TextView) view.findViewById(R.id.contentAnimal);
        ...
        imageAnimal.setImageResource(item.getIdImage());
    }
}
